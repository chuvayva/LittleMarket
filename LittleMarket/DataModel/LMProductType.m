...
{
    return [LMProductType stringWithPrice:self.price];
}
...
-(BOOL)isEqual:(id)object
{
    ...
    LMProductType *type = (LMProductType *)object;
...
{
    LMProductType *copy = [[LMProductType allocWithZone:zone] initWithName:self.name category:self.category price:self.price];
