...
@interface LMProductEditViewController ()
...
-(void)done
{
    LMProduct *newProduct = [[LMProduct alloc]initWithName:self.productName.text category:self.productCategory.text price:  [self.productPrice.text doubleValue] number:[self.productQuality.text integerValue]];
