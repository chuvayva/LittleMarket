...
@interface MarketCartViewController ()
...
@implementation MarketCartViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CartProductCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    Product *product = [_model cartProductAtIndex:indexPath.row];
